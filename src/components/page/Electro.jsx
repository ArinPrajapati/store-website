...
const Electro = () => {
  const clothingItems = data.filter((item) => item.tag === "electronics");
  return (
    <div className="">
      <h1 className="text-[5rem] font-Inter m-auto w-[29rem]  mb-[4rem] mt-[4rem] white_gradient ">Electronics</h1>
