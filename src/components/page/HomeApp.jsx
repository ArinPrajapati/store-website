...
const HomeApp = () => {
  ...
  const clothingItems = data.filter((item) => item.tag === "homeAppliances");
  return (
    <div className="">
      <h1 className="text-[5rem] font-Inter m-auto w-[50rem]  mb-[4rem] mt-[4rem] white_gradient ">Home Appliances</h1>
