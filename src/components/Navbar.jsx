...
const Navbar = () => {
  ...
  return (
    ...
    <div className="relative flex justify-between">
        ...
        <button type="submit" className="text-black absolute right-2.5 bottom-2.5 bg-slate-400 hover:bg-slate-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2">Search</button>
    </div>
</form>
      </section>
